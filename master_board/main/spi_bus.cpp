...
esp_err_t spi_bus_send_frame(SpiPkgType type, const void* payload, size_t payload_len){
...
esp_err_t spi_bus_recv_frame(SpiPkgType* out_type, void* out_payload, size_t* out_payload_len){
    // clear mem
